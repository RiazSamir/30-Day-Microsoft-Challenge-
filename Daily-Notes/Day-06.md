# Day 06 – Defender XDR integration & First Detection Rule  
...
- Created our first detection rule via Analytics for Brute Force Attacks (*Figure 3*)
...
- Integrating Defender XDR with Sentinel allows Incidents to include correlated entities rather than just isolated logs.
...
<p align="center"><b>Figure 3: Rule creation via Analytics to detect brute Force attacks.</b></p>
